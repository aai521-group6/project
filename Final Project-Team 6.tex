...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/PR_curve.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{images/P_curve.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/F1_curve.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/R_curve.png}
